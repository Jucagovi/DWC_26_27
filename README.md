## Desarrollo Web en Entorno Cliente (DWC) - GVA
...
* Gestionar eventos y asincronía.
...
* **UT01. Entorno de trabajo**: Introducción a los lenguajes de desarrollo cliente.
* **UT02. Sintaxis, funciones y componentes**: Sintaxis básica, tipos de datos y estructuras de control en JS.
* **UT03. Objetos predefinidos y hooks**: Objetos nativos, funciones y arrays.
* **UT04. Document Object Model y ciclo de vida**: Modelo de Objetos del Documento.
* **UT05. Eventos y Formularios**: Validación de formularios, almacenamiento local (Web Storage) y gestión de eventos.
...
1. Clona este repositorio en tu máquina local:
   ...
   ```bash
   git clone https://github.com/Jucagovi/DWC_26_27.git
   ```

2. Abre la carpeta del proyecto en Visual Studio Code.
3. Navega hasta el proyecto que desees revisar (React o Vanilla).
4. Abre un terminal en esa carpeta y ejecuta `npm run dev`.

### Licencia

Este proyecto está bajo la licencia GNU GENERAL PUBLIC LICENSE Version 3. Consulta el archivo [LICENSE](LICENSE) para más detalles.
